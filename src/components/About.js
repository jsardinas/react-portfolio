...
function Header() {
  return (
    <div className='about'>
      ...
      <p>Aspiring web developer with a background in mathematics.
        About six months of industry experience includes React, HTML, CSS, JavaScript, Bootstrap, jQuery, SQL, MongoDB, GraphQL, Node.js, Express.js, MVC and Git. Strong skills include bathing my dogs without getting too wet (they are big dogs), eating a bag of german cookies from H-E-B without sharing and solving the Rubik Cube in under a minute.</p>
    </div>
  );
}
